# Generated by Django 2.1.7 on 2019-03-22 15:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.SmallIntegerField(blank=True, choices=[(10, 'checking'), (20, 'publish'), (30, 'rejected'), (40, 'hidden')], default=10)),
                ('title', models.CharField(max_length=60)),
                ('description', models.TextField(max_length=5000)),
                ('price', models.DecimalField(decimal_places=2, default=0.0, max_digits=15)),
                ('contractual', models.BooleanField(blank=True, default=False)),
